...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.تفليش"))
async def _(event):
    await event.delete()
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.اكس او"))
async def _(event):
    bot = 'inlinegamesbot'
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.حجرة ورقة مقص"))
async def _(event):
    bot = 'inlinegamesbot'
    xo = await sedthon.inline_query(bot, "")
    await xo[4].click(
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.سورس"))
async def a(event):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.تهكير"))
async def a(event):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.صورته"))
async def _(event):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.ذاتية"))
async def _(event):
...
@بحر سيد.on(events.NewMessage(pattern=r"\.ادمن", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.انهاء الاسم الوقتي"))
async def _(event):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.اسم وقتي"))
async def _(event):
    time_name.clear()
    time_name.append("on")
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.انهاء البايو الوقتي"))
async def _(event):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.بايو وقتي"))
async def _(event):
    await event.delete()
    if event.fwd_from:
        return
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.بايو"))
async def _(event):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.غادر"))
async def leave(e):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.اذاعة كروب(?: |$)"))
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.اذاعة خاص(?: |$)(.*)"))
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.تكرار (.*)"))
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.مؤقت (.*)"))
async def spammer(event):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.اشتراكاتي"))
async def _(event):
    if event.fwd_from:
        return
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.الاوامر"))
async def _(event):
    await event.edit(commands)


@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.اوامري"))
async def _(event):
    await event.edit(commands)


@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.اوامر"))
async def _(event):
    await event.edit(commands)


@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.سورس"))
async def _(event):
    await event.edit(soursce)


@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.فحص"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit("جارٍ...")
    end = datetime.datetime.now()
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.م1"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec1)


@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.م2"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec2)


@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.م3"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec3)


@h_n_non(events.NewMessage(outgoing=True, pattern=r"\.م4"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec4)


@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.م5"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec5)


@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.الاوامر الخاصة"))
async def _(event):
    if ispay2[0] == 'yes':
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.التاريخ"))
async def _(event):
    await event.edit(f"""
`-- -- -- -- -- -- -- -- --`
	`الميلادي : {m9zpi}`
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.ايدي"))
async def _(event):
    reply_message = await event.get_reply_message()
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.المطور"))
async def _(event):
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.مطور"))
async def _(event):
    photo = await sedthon.get_profile_photos(DEVS[0])
    await sedthon.send_file(event.chat_id, photo, caption=f'''
    The best !
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.المبرمج"))
async def _(event):
    photo = await sedthon.get_profile_photos(DEVS[0])
    await sedthon.send_file(event.chat_id, photo, caption=f'''
    The best !
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.مبرمج"))
async def _(event):
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.البنك"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit("جارٍ...")
    end = datetime.datetime.now()
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.السنة"))
async def _(event):
    await event.edit(f"""
-- -- -- -- -- -- -- -- --
السنة : {y}
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.الشهر"))
async def _(event):
    await event.edit(f"""
-- -- -- -- -- -- -- -- --
الشهر : {m}
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.قمر"))
async def _(event):
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.قلب"))
async def _(event):
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.قلوب"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@بحر سيد.on(events.NewMessage(outgoing=True, pattern=r"\.فك حظر"))
async def _(event):
...
@h_n_n.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
